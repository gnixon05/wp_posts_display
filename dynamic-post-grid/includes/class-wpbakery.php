...
class DPG_WPBakery {
	...
	public static function map() {
		...
		$params = array(
			...
			array(
				'type'        => 'textfield',
				'heading'     => __( 'Max pill rows', 'dynamic-post-grid' ),
				'param_name'  => 'pill_rows',
				'value'       => '3',
				'description' => __( 'Cap the pills at this many rows, then show a "+N more" toggle. 0 = no row limit.', 'dynamic-post-grid' ),
				'dependency'  => array( 'element' => 'show_taxonomies', 'not_empty' => true ),
				'group'       => $group_content,
			),
			array(
				'type'        => 'textfield',
				'heading'     => __( 'Hard pill cap (count)', 'dynamic-post-grid' ),
				'param_name'  => 'pill_limit',
				'value'       => '0',
				'description' => __( 'Optional absolute maximum number of pills before "+N more" (also the no-JS fallback). 0 = off.', 'dynamic-post-grid' ),
				'dependency'  => array( 'element' => 'show_taxonomies', 'not_empty' => true ),
				'group'       => $group_content,
			),
			array(
